...
default_company_closure_filename = (
...
default_household_contact_matrix = np.array([[1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69],
          [1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69],
          [1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69],
          [1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69],
          [1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69],
          [1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69, 1.69],
          ...
          [1.27, 1.27, 1.27, 1.27, 1.27, 1.27, 1.30, 1.30, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34],
          [1.27, 1.27, 1.27, 1.27, 1.27, 1.27, 1.30, 1.30, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34],
          [1.27, 1.27, 1.27, 1.27, 1.27, 1.27, 1.50, 1.50, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 2.00, 2.00, 2.00],
          [1.27, 1.27, 1.27, 1.27, 1.27, 1.27, 1.50, 1.50, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 2.00, 2.00, 2.00],
          [1.27, 1.27, 1.27, 1.27, 1.27, 1.27, 1.50, 1.50, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 1.34, 2.00, 2.00, 2.00]])

# School contact matrix
default_school_contact_matrix = np.array([[2.5, 0.75, 0.25, 0.25, 0.25, 0.25, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15],
                         [0.75, 2.5, 0.75, 0.25, 0.25, 0.25, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15],
                         [0.25, 0.75, 2.5, 0.75, 0.25, 0.25, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15],
                         [0.25, 0.25, 0.75, 2.5, 0.75, 0.25, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15],
                         [0.25, 0.25, 0.25, 0.75, 2.5, 0.75, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15],
                         [0.25, 0.25, 0.25, 0.25, 0.75, 2.5, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15],
                         [0.75, 0.75, 0.75, 0.75, 0.75, 0.75, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8],
                         [0.75, 0.75, 0.75, 0.75, 0.75, 0.75, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8],
                         [0.75, 0.75, 0.75, 0.75, 0.75, 0.75, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8],
                         [0.75, 0.75, 0.75, 0.75, 0.75, 0.75, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8],
                         [0.75, 0.75, 0.75, 0.75, 0.75, 0.75, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8],
...
class ContactMatrixPlots():
    ...
    def __init__(
        ...
        self.sector_ratios = company_closure['company_closure']['sectors']
            ...
            if location == 'household':
                ...
                for i in range(len(self.world.companies)):   
                    for person in self.world.companies[i].people:
                        ratios = self.sector_ratios[person.sector]
                        activities_left = self.policies.individual_policies.apply(
                            active_individual_policies,
                            person=person,
                            activities=activities,
                            days_from_start=0,
                            key_ratio=ratios['key_worker'],
                            furlough_ratio=ratios['furlough'],
                            random_ratio=ratios['random']
                          )
                        if "primary_activity" in activities_left:
                            age_bin = bisect_right(self.bins, person.age)
