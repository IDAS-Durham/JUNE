...
#def update_data_old(people_from_abroad, data):
#    """
#    Given data from an MPI receive, create a dictionary of thin people specifications
#    (just enough information for them to infect and be infected).
#    """
...
#
#
#def delete_person_entry_old(to_send_abroad, person, external_subgroup: ExternalSubgroup):
#    try:
