...
#
#default_uk_pcs_coordinates = (
#    default_data_path / "input/geography/postcodes_coordinates.csv"
#)
#
...
#)
#
#default_non_london_stat_pcs = (
#    default_data_path / "input/travel/non_London_station_coordinates.csv"
#)
#
#default_london_stat_pcs = (
#    default_data_path / "input/travel/London_station_coordinates.csv"
#)
#
#
...
#
#    def __init__(
#        self, city=None, super_area=None, metro_msoas=None, metro_centroid=None
#    ):
#        """
...
#            city_metro_msoas, city_metro_centroid = get_nearest_msoas(
#                lat_lon_stat, lat_lon_msoas, msoas, lat_msoas, lon_msoas
#            )
#
...
#        city_metro_centroid = [
#            np.mean(city_metro_centroid_all[:, 0]),
#            np.mean(city_metro_centroid_all[:, 1]),
#        ]
#        msoa_stat, _ = get_nearest_msoas(
#            city_metro_centroid, lat_lon_msoas, msoas, lat_msoas, lon_msoas, nearest=1
#        )
#
#        super_area_stat = None
#        for super_area in super_areas:
...
#
#    lat_lon_msoa_stat = lat_lon_msoas[
#        spatial.KDTree(lat_lon_msoas).query(lat_lon_stat)[1]
#    ]
...
#
#
#def get_nearest_msoas(
#    lat_lon_stat, lat_lon_msoas, msoas, lat_msoas, lon_msoas, nearest=20
#):
...
#    city_metro_centroid = [
#        np.mean(lat_msoas[metro_indices]),
#        np.mean(lon_msoas[metro_indices]),
#    ]
#
