...
default_distribution_centers_coordinates_filename = data_path / "input/activities/distirbution_centers.csv"
...
class DistributionCenterDistributor(SocialVenueDistributor):
    def __init__(
        self,
        distribution_center: DistributionCenters,
        ...
        super().__init__(
            social_venues=distribution_center,
    ...
    @classmethod
    def from_config(cls, distribution_center: DistributionCenters, config_filename: str = default_config_filename):
        with open(config_filename) as f:
            config = yaml.load(f, Loader=yaml.FullLoader)
        return cls(distribution_center, **config)
