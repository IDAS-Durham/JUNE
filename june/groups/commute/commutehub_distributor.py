...
class CommuteHubDistributor:
    ...
    def _get_msoa_oa(self, oa):
        ...
        msoa = self.msoa_oa_coordinates["MSOA11CD"][
            self.msoa_oa_coordinates["OA11CD"] == oa
        ]
    ...
    def _get_area_lat_lon(self, oa):
        ...
        lat = float(
            self.msoa_oa_coordinates["Y"][self.msoa_oa_coordinates["OA11CD"] == oa]
        )
        lon = float(
            self.msoa_oa_coordinates["X"][self.msoa_oa_coordinates["OA11CD"] == oa]
        )
