...
#pyplot.figure(figsize=set_size(subplots=(1,1), fraction=.48))
...
def legend(fig, axes, x0=1,y0=.5, direction = "v", padpoints = 3,**kwargs):
    
    otrans = axes[0].figure.transFigure
    t = axes[0].legend(bbox_to_anchor=(x0,y0), loc="center", bbox_transform=otrans,**kwargs)
