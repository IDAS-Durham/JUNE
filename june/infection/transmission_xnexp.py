...
class TransmissionXNExp(Transmission):
    def __init__(
        self, max_probability=1.0, start_transmission=2.6, norm_time=1.0, N=1.0, alpha=5.0
    ):
    ...
    @classmethod
    def from_file(cls, start_transmission, N, alpha, config_path: str  = default_config_path) -> "TransmissionXNExp":
        ...
        return TransmissionXNExp(max_probability=max_probability,
