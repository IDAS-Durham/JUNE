...
class HealthIndexGenerator:
    ...
    def __init__(self, poli_hosp: dict, poli_icu: dict, poli_deaths: dict,Asimpto_ratio=0.1):
        """
        Parameters:
    ...
    @classmethod
    def from_file(
            cls, polinome_filename: str = default_polinom_filename,asymptomatic_ratio=0.1
    ...
    def make_list(self):
        ...
        ratio_Hosp_withICU_female=self.model(ages,self.Poli_Hosp[0])#Going to the Hospital but not to ICU
        ...
        ratio_Hosp_withICU_male=self.model(ages,self.Poli_Hosp[1])#Going to the Hospital but not to ICU
        ...
        ratio_Hosp_female=ratio_Hosp_withICU_female-ratio_ICU_female
        ratio_Hosp_male=ratio_Hosp_withICU_male-ratio_ICU_male

  
        #Probability of being simptomatic but not going to hospital
        No_Hosp_female=1.0-self.Asimpto_ratio-ratio_Hosp_withICU_female
        No_Hosp_male=1.0-self.Asimpto_ratio-ratio_Hosp_withICU_male
