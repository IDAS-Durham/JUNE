...
class Data2Rates:
    def __init__(
        ...
        self.care_home_ratios_by_age_sex_df = care_home_ratios_by_age_sex_df
    ...
    def from_files(
        ...
        if care_home_ratios_by_age_sex_file is None:
            ...
            care_home_ratios_by_age_sex_df = cls.read_csv(care_home_ratios_by_age_sex_file,
                        converters=False)
        return cls(
            seroprevalence_df=seroprevalence_df,
            population_by_age_sex_df=population_df,
            all_deaths_by_age_sex_df=all_deaths_df,
            #care_home_deaths_by_age_sex_df=care_home_deaths_by_age_sex_df
