...
def save_symptoms_to_hdf5(
    ...
    """
    Saves symptoms data to hdf5. The symptom type is inferred from the first
    element of the list.
    ...
    with h5py.File(hdf5_file_path, "a") as f:
        f.create_group("symptoms")
        n_symptoms = len(symptoms_list)
        f["symptoms"].attrs["n_symptoms"] = n_symptoms
