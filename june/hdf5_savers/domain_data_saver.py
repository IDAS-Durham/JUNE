...
def save_data_for_domain_decomposition(world: World, file_path: str):
    ...
    super_area_population = np.array(super_area_population, dtype=np.int)
    super_area_workers = np.array(super_area_workers, dtype=np.int)
    super_area_commuters = np.array(super_area_commuters, dtype=np.int)
    super_area_pupils = np.array(super_area_pupils, dtype=np.int)
