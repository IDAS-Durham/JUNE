...
class LifeExpectancyPlots:
    ...
    def load_geography_data(self):
        ...
        oa_lsoa_path = data_path / "oa_lsoa_msoa_lad.csv"
        ...
        wd_wcmd_path = data_path / "w_cmw_lad.csv"
        ...
        oa_wd_path = data_path / "oa_w_lad.csv"
        ...
        oa_cmwd = pd.merge(
            oa_wd, wd_cmwd, left_on="wd",right_on="wd",how="outer",validate="many_to_one"
        )
        ...
        print(f'drop {old_len-len(oa_cmwd)} duplicate OAs...')
    ...
    def load_iomd(self):
        ...
        eng_iomd_path = data_path / "eng_lsoa_iomd_2019.xlsx"
        eng_iomd = pd.read_excel(eng_iomd_path,sheet_name=1,index_col=0)
        ...
        eng_iomd['iomd_decile'] = get_xtile(eng_iomd['iomd_rank'],x=10) / 10 # For testing only.
        eng_iomd['iomd_centile'] = get_xtile(eng_iomd['iomd_rank'],x=100) / 100
    ...
    def load_life_expectancy(self):
        ...
        le_path = data_path / "life_expectancy.xls"
...
if __name__ == "__main__":
    le_plotter = LifeExpectancyPlots()
    le_plotter.load_geography_data()
    le_plotter.load_iomd()

    # If want to save oa->socioecon mapping, do it now - some OAs are removed in next function...
    le_plotter.load_life_expectancy()
    le_plotter.plot_life_expectancy_socioecon_index()
