...
if __name__ == "__main__":
    ...
    world_file = Path(
        #f"/cosma7/data/durham/dc-sedg2/june_runs/june_worlds/up_to_date/test_world.hdf5"
        f"/cosma6/data/dp004/dc-quer1/june_worlds/up_to_date/parallel/london.hdf5"
    )

    world = generate_world_from_hdf5(world_file)
    sc = SchoolPlots(world)
    
    sc.load_school_data()

    sc.plot_school_sizes()
    sc.plot_student_teacher_ratio()
    sc.plot_distance_to_school()
