...
class TestInfection:
    ...
    def test__infect_person__gives_them_symptoms_and_transmission(self, transmission, symptoms_constant):
        ...
        infection.infect_person_at_time(person=person, health_index_generator=health_index_generator, time=0.2)
        ...
        assert person.health_information.infection.transmission.probability == 0.3
