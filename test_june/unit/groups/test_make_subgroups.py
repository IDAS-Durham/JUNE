...
interaction_config = paths.configs_path / "tests/groups/make_subgroups_test_interaction.yaml"
...
def test_excel_cols():
    assert list(itertools.islice(make_subgroups.Subgroup_Params().excel_cols(),10)) == ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"]
